...
JWT_SECRET_KEY: str = os.getenv("JWT_SECRET_KEY",
                                "msdnvknfbslkdnbsdfnowiekvnslfnbsenfbyugvhbjkbhyrdzvjvgtfxreztrzh657465343765907uykvh")
JWT_ALGORITHM: str = os.getenv("JWT_ALGORITHM", "HS256")
ACCESS_TOKEN_EXPIRE_MINUTES: float = float(os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES", "15"))
